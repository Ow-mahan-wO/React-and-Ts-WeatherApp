...
export class PredictionWeather extends React.Component<Props> {
        ...
        <div className="w-100% p-3 mt-10">
            ...
            <div className="flex items-center">
              <p className="font-bold text-2xl text-orange-400">
                {this.props.MinTemp && this.props.MaxTemp
                  ? `${Math.trunc(this.props.MaxTemp - 273)}°C" / "${Math.floor(
                      this.props.MinTemp - 273
                    )}°C`
                  : "Min / Max"}
              </p>
            </div>
          ...
          <div className="flex justify-between h-32 p-3 mt-4 bg-white rounded-2xl ">
            <div className="flex items-center">
              ...
              <div className="ml-5">
                <p className=" text-2xl">After Tomorrow</p>
            ...
            <div className="flex items-center">
              <p className="font-bold text-2xl text-orange-400">
                {this.props.MinTemp && this.props.MaxTemp
                  ? `${Math.trunc(this.props.MaxTemp - 270)}°C / ${Math.floor(
                      this.props.MinTemp - 270
                    )}°C`
                  : "Min / Max"}
              </p>
            </div>
